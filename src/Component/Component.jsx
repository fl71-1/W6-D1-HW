...
export default function Component () {
  return (
    ...
    <div class="w-1/4 h-1/4   m-2 flex items-center justify-center bg-white font-bold bg-opacity-10 backdrop-filter backdrop-blur-lg hover:bg-opacity-20 text-white font-semibold py-2 px-4 rounded">
